...
type SellingPlanAllocation struct {
	SellingPlanID    int64                        `json:"selling_plan_id,omitempty"`
	Price            *decimal.Decimal             `json:"price,omitempty"`
	CompareAtPrice   *decimal.Decimal             `json:"compare_at_price,omitempty"`
	PerDeliveryPrice *decimal.Decimal             `json:"per_delivery_price,omitempty"`
	PriceAdjustments []SellingPlanPriceAdjustment `json:"price_adjustments,omitempty"`
}
...
type LineItem struct {
	...
	SellingPlanID              int64                  `json:"selling_plan_id,omitempty"`
	SellingPlanAllocation      *SellingPlanAllocation `json:"selling_plan_allocation,omitempty"`
